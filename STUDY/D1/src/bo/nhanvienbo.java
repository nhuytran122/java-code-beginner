...
public class nhanvienbo {
	...
	public int them(String manv, String hoTen, String gioiTinh, Date ngaySinh, String sdt, String diachi,
		Date ngaylamviec, Long luong) throws Exception {
		//kiem tra trung ma
	...
	public int sua(String manv, String hoTen, String gioiTinh, Date ngaySinh, String sdt, String diachi,
			Date ngaylamviec, Long luong) throws Exception {
