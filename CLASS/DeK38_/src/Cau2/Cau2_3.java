...
public class Cau2_3 {
	public void Tachdong_tufile(ArrayList<Integer> kq, ArrayList<String> tt2){
...
//	}
	...
	public void XuatThongTinGt(ArrayList<String> tt2, ArrayList<Integer> kq, int svdb, ArrayList<String> giaithuong, ArrayList<BigInteger> tienthuong) {
		try {
	...
	public void Napdata(ArrayList<String> tt2, ArrayList<BigInteger> tienthuong, ArrayList<String> giaithuong) {
		try {
			ketnoi();
			...
			PreparedStatement cmd = Cau2_3.cn.prepareStatement(sql);
			PreparedStatement cmd2 = Cau2_3.cn.prepareStatement(sql2);
