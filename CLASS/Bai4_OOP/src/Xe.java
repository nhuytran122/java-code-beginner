...
public abstract class Xe {
	...
	public Xe(String cmnd, String hoten, String gioitinh, String mscanho, String mauson, Date timeVao, Date timeRa) {
		super();
		this.cmnd = cmnd;
		this.hoten = hoten;
	...
	public abstract int tinhTien();{ // Hàm để tính tiền đỗ xe (sẽ được override trong các lớp con)
	}
