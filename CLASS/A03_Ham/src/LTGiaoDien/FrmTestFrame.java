...
public class FrmTestFrame extends JFrame {
	...
	public FrmTestFrame() {
		...
		txtgia.setBounds(138, 81, 277, 32);
		contentPane.add(txtgia);
		txtgia.setColumns(10);
		
		JLabel lblNewLabel_1 = new JLabel("Nhập số lượng");
		lblNewLabel_1.setBounds(31, 150, 71, 14);
		...
		cmbhang.setBounds(138, 27, 277, 32);
